...
-- Instances: 12 | Scripts: 6 | Modules: 0 | Tags: 0
local G2L = {};
...
G2L["3"]["Size"] = UDim2.new(0, 636, 0, 34);
G2L["3"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["3"]["Text"] = [[Main]];
G2L["3"]["Name"] = [[DragForScript]];
G2L["3"]["Position"] = UDim2.new(0.16793, 0, 0.12384, 0);


-- StarterGui..DragForScript.drag
G2L["4"] = Instance.new("LocalScript", G2L["3"]);
G2L["4"]["Name"] = [[drag]];


-- StarterGui..DragForScript.Script
...
G2L["5"]["Size"] = UDim2.new(0, 636, 0, 376);
G2L["5"]["Position"] = UDim2.new(0.49994, 0, 6.51067, 0);
G2L["5"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["5"]["Name"] = [[Script]];


-- StarterGui..DragForScript.Script.LocalScript
G2L["6"] = Instance.new("LocalScript", G2L["5"]);



-- StarterGui..DragForScript.Script.Freecam
G2L["7"] = Instance.new("LocalScript", G2L["5"]);
G2L["7"]["Name"] = [[Freecam]];


-- StarterGui..DragForScript.Script.TextButton
...
G2L["8"]["Size"] = UDim2.new(0, 66, 0, 56);
G2L["8"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["8"]["Text"] = [[Freecamera]];
G2L["8"]["Position"] = UDim2.new(0.02516, 0, 0.04803, 0);


-- StarterGui..DragForScript.Script.TextButton.LocalScript
...
G2L["a"]["Size"] = UDim2.new(0, 66, 0, 56);
G2L["a"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["a"]["Text"] = [[IY]];
G2L["a"]["Position"] = UDim2.new(0.15723, 0, 0.04803, 0);
...
-- StarterGui..DragForScript.UICorner
...
local function C_2()
local script = G2L["2"];
	-- This is a LocalScript, so it will run on the client.
	-- Make sure to place this script inside the ScreenGui that contains the Frame named "Frame".
	
	local frame = script.Parent:WaitForChild("Frame")
	
	if frame and frame:IsA("Frame") then
		local textLabel = frame:FindFirstChild("RnTl") -- TextLabel inside the Frame is named "RnTl"
	
		if textLabel and textLabel:IsA("TextLabel") then
			textLabel.Text = "Script has loaded!"
			...
			warn("TextLabel named 'RnTl' not found inside the Frame named 'Frame'.")
		end
	else
		warn("Frame named 'Frame' not found in this GUI.")
	end
end;
task.spawn(C_2);
-- StarterGui..DragForScript.drag
...
local function C_9()
local script = G2L["9"];
	-- This is a LocalScript placed directly inside the button named "Freecambut".
	...
	if button and (button:IsA("TextButton") or button:IsA("ImageButton")) then
		button.MouseButton1Click:Connect(function()
			...
			print("Button was clicked, executing embedded script...")
			------------------------------------------------------------------------
			-- Freecam
			-- Cinematic free camera for spectating and video production.
			------------------------------------------------------------------------
		...
		warn("This script is not a child of a Button (TextButton or ImageButton).")
	end
end;
task.spawn(C_9);
-- StarterGui..DragForScript.Script.TextButton.LocalScript
